package com.robotemplates.cookbook.fcm;
...
public class CookbookFirebaseMessagingService extends FirebaseMessagingService {
	@Override
	...
	public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
		...
		if (remoteMessage.getNotification() != null) {
			...
			sendNotification(title, text, sound);
		}
	}

	private void sendNotification(String title, String text, String sound) {
		...
		if (notificationManager != null) {
			...
			notificationManager.notify(0, createNotification(title, text, sound, channelId));
		}
	}

	private Notification createNotification(String title, String text, String sound, String channelId) {
